...
tags:
  ...
  - rails
header:
  image: /assets/images/post-banners/es_docker.png
---
...
{% highlight ruby %}
Account.**elasticsearch**.create_index! force: true
Account.**elasticsearch**.refresh_index!
{% endhighlight %}
...
Account.**elasticsearch**.create_index!
end
{% endhighlight %}
